...
# auto-generated with manual fixes and modifications,
...
#     tagPARAMDESCEX, tagSAFEARRAYBOUND, tagSYSKIND, tagTLIBATTR, \
...
class IPortableDeviceService(IUnknown):
...
class IPortableDeviceWebControl(IDispatch):
    _case_insensitive_ = True
...
IPortableDeviceKeyCollection._methods_ = [
    COMMETHOD(
        ...
        HRESULT,
        'GetCount',
        # likely supposed to be 'out', not tested
...
class IPortableDeviceEventCallback(IUnknown):
...
class PROPVARIANT_inner_union(Union):
    pass
...
PROPVARIANT_inner_union._fields_ = [
    ('cVal', c_char),
    ('bVal', c_ubyte),
    ('iVal', c_short),
    ('uiVal', c_ushort),
...
assert sizeof(PROPVARIANT_inner_union) == 16, sizeof(PROPVARIANT_inner_union)
assert alignment(PROPVARIANT_inner_union) == 8, alignment(PROPVARIANT_inner_union)
...
tag_inner_PROPVARIANT._fields_ = [
    ...
    ('wReserved2', c_ubyte),
    ('wReserved3', c_ulong),
    # fixed: renamed the union to a more usable name
    ('DUMMYUNIONNAME', PROPVARIANT_inner_union),
]
...
class IPortableDeviceServiceMethods(IUnknown):
...
class IPortableDeviceServiceCapabilities(IUnknown):
...
class IPortableDeviceCapabilities(IUnknown):
...
__all__ = [
    'IPortableDeviceResources', 'tagCABOOL',
    'IPortableDeviceKeyCollection', 'PortableDevice', 'tagRemSNB',
    'tagCABSTRBLOB', 'tagCAL', 'tagCAUI', 'tagCALPSTR',
    'IPortableDeviceContent', '_wireBRECORD', 'tagCAFLT',
    'PROPVARIANT_inner_union', 'tagCADBL',
    '_wireSAFEARRAY', 'PortableDeviceManager', '_wireSAFEARR_VARIANT',
    '_wireSAFEARR_UNKNOWN', '_wireSAFEARR_DISPATCH', 'IPropertyStore',
    'tagCLIPDATA', 'tagSTATSTG', '_wireSAFEARR_BRECORD',
    '__MIDL_IOleAutomationTypes_0005', 'IEnumSTATSTG',
    'tag_inner_PROPVARIANT', '_wireSAFEARR_HAVEIID',
    'IPortableDeviceValuesCollection', 'tagCASCODE', 'IStream',
    'IPortableDeviceProperties', '_LONG_SIZEDARR', '_wireVARIANT',
    'tagCAPROPVARIANT', 'tagCAFILETIME', 'IPortableDeviceService',
    'IPortableDevicePropVariantCollection',
    'PortableDeviceServiceFTM', 'IPortableDevice',
    'PortableDeviceFTM', 'PortableDeviceWebControl', 'tagBLOB',
    'tagCAI', 'tagCAUH', 'IPortableDeviceDispatchFactory',
    '_wireSAFEARRAY_UNION', 'IPortableDeviceServiceMethodCallback',
    'IPortableDeviceManager', 'wireSNB', 'IPortableDeviceContent2',
    'IPortableDeviceValues', 'tagCAH', '_BYTE_SIZEDARR', 'tagCADATE',
    'tagCAUL', 'ISequentialStream', 'tagCABSTR', 'tagVersionedStream',
    'PortableDeviceDispatchFactory', 'IPortableDeviceEventCallback',
    'PortableDeviceService', '_SHORT_SIZEDARR',
    '__MIDL_IOleAutomationTypes_0004', 'tagCAUB',
    'IPortableDeviceServiceCapabilities', '_tagpropertykey',
    'tagCACY', 'tagCAC', 'tagCALPWSTR', '_wireSAFEARR_BSTR',
    'IPortableDeviceWebControl', 'wirePSAFEARRAY',
    '__MIDL_IOleAutomationTypes_0006', 'IEnumPortableDeviceObjectIDs',
    'tagCACLIPDATA', '_HYPER_SIZEDARR', 'IPortableDeviceCapabilities',
    '__MIDL_IOleAutomationTypes_0001', 'tagCACLSID',
    'IPortableDeviceServiceMethods', 'tagBSTRBLOB', 'IStorage',
    '_FLAGGED_WORD_BLOB'
]

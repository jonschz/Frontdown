# -*- coding: mbcs -*-
# file auto-generated by comtypes
...
from comtypes import _check_version, BSTR, CoClass, COMMETHOD, GUID, IUnknown   # type: ignore[import]
...
# TODO: this is identical to _1F00...'s PROPVARIANT_inner_union. We could import one from the other, or move this into a common file
...
__all__ = [
    'tagCAI', '__MIDL___MIDL_itf_PortableDeviceTypes_0003_0017_0001',
    'tagCACLSID', 'tagCAFLT', '_wireVARIANT', '_wireSAFEARR_UNKNOWN',
    'tagCASCODE', '_BYTE_SIZEDARR', '_wireSAFEARR_BSTR', 'tagCADATE',
    '_wireSAFEARR_HAVEIID', 'IPortableDevicePropVariantCollection',
    '__MIDL_IOleAutomationTypes_0001', 'tagCADBL', 'tagBSTRBLOB',
    'tagCAUH', '_LONG_SIZEDARR', 'tagCAUI', 'tagCAUB',
    '_wireSAFEARR_BRECORD', 'tagCAUL', 'IPortableDeviceValues',
    '_FLAGGED_WORD_BLOB', 'tagCAPROPVARIANT', 'tagCAL',
    'IEnumSTATSTG', 'tagCABSTR', 'tagCABOOL', 'ISequentialStream',
    'tag_inner_PROPVARIANT', '_tagpropertykey', 'tagSTATSTG',
    'IPropertyStore', '__MIDL_IOleAutomationTypes_0006',
    '__MIDL_IOleAutomationTypes_0004', '_wireSAFEARRAY_UNION',
    'tagCALPSTR', '__MIDL_IOleAutomationTypes_0005',
    'PortableDeviceValues', 'PortableDevicePropVariantCollection',
    'PortableDeviceValuesCollection', 'WpdSerializer', 'IStream',
    'tagVersionedStream', 'wirePSAFEARRAY', '_wireSAFEARR_VARIANT',
    'tagCACLIPDATA', 'tagCAC', 'tagCAH', '_HYPER_SIZEDARR',
    'tagCAFILETIME', 'tagBLOB', '_wireBRECORD', 'tagCACY',
    'tagCABSTRBLOB', 'tagCLIPDATA', 'tagCALPWSTR', 'tagRemSNB',
    '_SHORT_SIZEDARR', 'IPortableDeviceKeyCollection',
    '_wireSAFEARR_DISPATCH', 'wireSNB', 'PortableDeviceKeyCollection',
    'IPortableDeviceValuesCollection', 'IStorage', 'IWpdSerializer',
    '_wireSAFEARRAY'
]
